...
class MyCircularDeque:
    ...
    def insertFront(self, value: int) -> bool:
        ...
        self.left = (self.left - 1 + self.cap) % self.cap
    ...
    def deleteLast(self) -> bool:
        ...
        if self.size == 0:
            return False
        self.right = (self.right - 1 + self.cap) % self.cap
        self.size -= 1
        return True
    ...
    def getFront(self) -> int:
        ...
        if self.size == 0:
            return -1
        return self.d[(self.left + 1) % self.cap]
    ...
    def getRear(self) -> int:
        ...
        if self.size == 0:
            return -1
        return self.d[(self.right - 1 + self.cap) % self.cap]
