...
MyCircularDeque.prototype.insertFront = function(value) {
    ...
    this.left = (this.left - 1 + this.cap) % this.cap
    this.size++
    return true
};
...
MyCircularDeque.prototype.deleteLast = function() {
    ...
    this.right = (this.right - 1 + this.cap) % this.cap
    this.size--
    return true
};
...
MyCircularDeque.prototype.getFront = function() {
    ...
    return this.arr[(this.left + 1) % this.cap]
};
...
MyCircularDeque.prototype.getRear = function() {
    ...
    return this.arr[(this.right - 1 + this.cap) % this.cap]
};
